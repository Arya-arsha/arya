...
public class SeasonAddController implements ActionListener {
	
	private Container container=null;
	private SeasonModel season=null;
	private SeriesModel series=null;
	private JDialog dialog=null;
	public SeasonAddController(Container container,SeriesModel series,JDialog dialog) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			setData();
			new CURDSeries().insertSeason(season, series.getId());
			dialog.dispose();
			...
			// TODO Auto-generated catch block
			e1.printStackTrace();
			JOptionPane.showMessageDialog(null, "Couldn't insert season"
					,"WARNING", JOptionPane.WARNING_MESSAGE);
