...
public class SeriesAddController implements ActionListener {
	private Container container=null;
	private SeriesModel series=null;
	public SeriesAddController(Container container,SeriesModel series)
	{
		super();
	...
	public void actionPerformed(ActionEvent e) 
	{
		try {
			setData();
			new CURDSeries().insertSeries(series);
			...
			e1.printStackTrace();
			JOptionPane.showMessageDialog(null, "Couldn't insert series"
